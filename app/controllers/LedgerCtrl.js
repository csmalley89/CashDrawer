...
/* Open Shop Controller */

app.controller('LedgerOpenCtrl', function($scope, $window, $location, InventoryFactory){
  $scope.cashDrawerTotal = 0;
  $scope.title = "Ready to open shop?";
...
/**
 *
 * CLOSE SHOP CONTROLLER
 *
 */


app.controller('LedgerCloseCtrl', function($scope, $window, $location, InventoryFactory){
  $scope.cashDrawerTotal = 0;
  $scope.title = "Ready to close shop?";
